...
class CustomerUserGroup(UpdatedCreated):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE,blank=True, null=True, db_column='membership_customer')
    user = models.ForeignKey(User, on_delete=models.CASCADE,blank=True, null=True, db_column='membership_user')
