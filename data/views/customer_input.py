...
from data.serializers.customer_input import (
    CustomerInputSerializers,
    CustomerPayloadSerializers,
)
...
class CustomerInputViewClass(ViewSet):
    ...
    def create(self, request, customer_code, retail_store_code):
        ...
        try:
            ...
            raise InvalidParameter("Customer must be a valid JSON")
        ...
        self.customer_input_logic.create(
            customer, customer_csv, customer_code, retail_store_code
        )
    ...
    def list(self, request, customer_code, retail_store_code):
        ...
        uuid_validator(retail_store_code)
        uuid_validator(customer_code)
        customer_input_json = self.customer_input_logic.list(
            customer_code, retail_store_code
        )
